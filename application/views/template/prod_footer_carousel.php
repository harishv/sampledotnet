...
<?php
	...
	<ul class="nav nav-tabs" id="my_carousel_tabs">
		<?php
			...
			<li class="<?php echo $li_class; ?>">
				<a data-toggle="tab" href="#my_tab_<?php echo $category['category_id']; ?>"><?php echo $category['prod_cat_name']; ?></a>
			</li>
		<?php
			$flag = false;
			} ?>
	...
	<div class="tab-content" style="overflow: hidden;">
		<?php
			$flag = true;
			foreach ($footer_products as $products) {
				$main_div_class = '';
				$p_class = '';
				if ($flag) {
			...
			?>
			<div id="my_tab_<?php echo $products[0]['category_id']; ?>" class="tab-pane fade <?php echo $main_div_class; ?>">
						...
						<div class="content-conveyor ui-helper-clearfix tabs1">
							...
							<div class="item">
								<p class="<?php echo $p_class; ?>">
									...
									<a href="<?php echo base_url().'product/product_detail/'.$item['id'];?>"><img src="<?php echo base_url().PROD_THUMB_IMG_PATH.'thumb_'.$item['image'];?>" alt="<?php echo $item['name']; ?>" title="<?php echo $item['name']; ?>" /></a>
									<br />
									...
									?>
									<a href="<?php echo base_url().'product/product_detail/'.$item['id'];?>"><strong><?php echo $item_short_name; ?></strong></a>
									<br />
