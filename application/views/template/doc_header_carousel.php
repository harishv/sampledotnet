	...
	<ul id="mycarousel" class="jcarousel-skin-tango mgn-15b">
		<?php /* if(isset($featured_documents) && $featured_documents != '') {
				foreach ($featured_documents as $featured_documents_key => $featured_documents_values) { ?>
					<li>
						<a href="<?php echo base_url().'documents/document_details/'.$featured_documents_values['id'];?>">
							<img src="<?php echo $featured_documents_values['thumb_url'];?>" alt="<?php echo $featured_documents_values['name']; ?>" width='86' height='98' />
							<br />
							<?php
