...
<?php }?>
      ...
      <div class="flt-l wid_100" id="main-content">
		...
		<!-- End column 1 -->
          ...
          <p class="links">
          <a href="<?php echo base_url() . '/documents';?>">Home</a><img alt="blue" src="<?php echo base_url().'img/blue-bullet.jpg';?>"/><?php if(isset($bread_crum) && $bread_crum !='') ?> <a href="<?php echo base_url().'docs_category/parent_category/'.$bread_crum['parent_cat_id']?>"><?php echo $bread_crum['cat_name'];?></a><?php if($bread_crum['cat_name'] !='') { ?><img alt="blue" src="<?php echo base_url().'img/blue-bullet.jpg';?>">  <?php } ?><?php  if(isset($bread_crum) && $bread_crum !='') echo $bread_crum['sub_cat_name'];?>
          </p>
