	...
	<div class="flt-l" id="content">
		...
		<div class="hgt-15px wid_100" style="min-height: 750px; height: inherit;">
			...
			<div class="pdf-book clearfix">
				<a class="btn btn-info btn-download pull-right" href="<?php echo base_url().'documents/download_pdf/'.$document_details[0]['id'];?>"><i class="icon-white icon-download-alt"></i> Download</a>
